const RESUME = {
  ...
  experience: [
    ...
    },
    {
      icon: (
        <svg
          aria-label="Emergent logomark"
          height="64"
          role="img"
          style={{ width: "auto", overflow: "visible" }}
          viewBox="191.5 164 14.5 15.5"
        >
          <path
            d="M 208.218 171.372 C 208.371 175.029 206.39 178.605 202.889 180.312 C 199.389 182.019 195.353 181.379 192.566 179.005 L 196.017 177.323 C 197.667 178.127 199.655 178.189 201.433 177.323 C 203.209 176.456 204.384 174.85 204.766 173.056 L 208.218 171.372 Z M 194.563 163.238 C 199.277 160.938 204.964 162.896 207.264 167.611 C 207.404 167.899 207.528 168.19 207.637 168.485 L 190.648 176.77 C 190.483 176.504 190.331 176.226 190.189 175.939 C 187.891 171.224 189.849 165.537 194.563 163.238 Z M 202.81 167.141 C 200.995 165.544 198.328 165.099 196.02 166.225 C 193.711 167.35 192.42 169.727 192.561 172.139 L 202.81 167.141 Z"
            fill="white"
            style={{ strokeWidth: 1 }}
          />
        </svg>
