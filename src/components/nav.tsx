...
export default function Nav() {
  ...
  const hoverTransition: Transition = reduceMotion
    ? { duration: 0 }
                            ...
                            >
                              ...
                              >
                                {activeTab === tab.name && (
                                  <motion.span
                                    layoutId="nav-active"
                                    className="pointer-events-none absolute inset-0 rounded-lg border border-primary/20 bg-primary/15 dark:border-primary/30 dark:bg-primary/20"
                                ...
                                {hoveredTab === tab.name && activeTab !== tab.name && (
                                  <motion.span
                                    layoutId="nav-hover"
                                    className="pointer-events-none absolute inset-0 rounded-lg border border-white/10 bg-white/10 dark:bg-white/5"
